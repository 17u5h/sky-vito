...
import {getUserSelector, userAvatarSelector, userNameSelector} from "../../../store/selectors/getUserSelector";
...
const UserData = () => {
	...
	const initialAvatar = {background: `#f0f0f0 url("${userAvatar}") no-repeat center`}
	...
	const changePhoto = () => {
		setAvatar({background: `#f0f0f0 url("${user.img}") no-repeat center`})
	}
